namespace _13_Funkce
{
    class Program
    {
        ...
        {
            double[] arr = new double[input_5.Length];
        ...
        protected static bool Function8(int input_8_A, int v)
        {
            return input_8_A % v == 0;
        }
        ...
        /// <summary>
        /// Funkce vracejici hráčovu novou přezdívu
        /// </summary>
        /// <param name="input_3_name">jméno</param>
        /// <param name="input_3_age">rok narození</param>
        /// <returns>textová podoba přezdívky</returns>
