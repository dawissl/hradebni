...
namespace Functions
{
    class Program
    {
        ...
        private static int[] Function1(int a, int b, int c)
        {
            int[] tmp = { b, a, c };
            Array.Sort(tmp);
            return tmp;
        ...
        protected static int Function2(int a, int b, int c, int d)
        {
            int max = a;
            if (max < b)
            {
        ...
        public static double[] Function5(double[] pole)
        {
        ...
        private static int Function9(int a, int b)
        {
            return a + b;
        }
        ...
        // ahoj svete. Jak se MAS? , a -> 3
        public static int Function11(string veta, char pismeno)
        {
            int i = 0;
            string tmp = pismeno.ToString().ToUpper();
            foreach(char letter in veta.ToUpper()){
                if(letter == char.Parse(tmp))
                {
                    i++;
                }
