...
namespace Functions
{
    class Program
    {
        ...
        private static void Funkce6(string input_6)
        {
        ...
        private static Osoba Function4(string input_4_name, string input_4_surname, int input_4_salary)
        {
            throw new NotImplementedException();
        }

        private static string Function3(string input_3_name, int input_3_age)
        {
            return $"{input_3_name}_{input_3_age}";
        }

        private static int Function2(int v1, int v2, int v3, int v4)
        {
            int[] arr = { v1, v2, v3, v4 };
